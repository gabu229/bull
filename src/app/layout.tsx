...
export const metadata: Metadata = {
  title: "Coinbull - Real-time Cryptocurrency Prices",
  description:
    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${font.className} antialiased`}>
        <ProgressBarProvider>
          ...
          <div
            className="fixed inset-x-0 top-2/4 -z-10 transform-gpu overflow-hidden blur-3xl sm:-bottom-80a opacity-80 rotate-180"
            aria-hidden="true"
          >
            <div
